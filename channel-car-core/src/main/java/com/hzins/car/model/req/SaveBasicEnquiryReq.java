...
import com.hzins.car.model.info.InsureCarInfo;
 ...
 * @version
 */
public class SaveBasicEnquiryReq {
    ...
    public InsureCarInfo getCarInfo() {
	return carInfo;
    }

    public void setCarInfo(InsureCarInfo carInfo) {
